...
arsoru2 = Array("Soru2-1.alternatif", "Soru2-2.alternatif", "Soru2-3.alternatif", "Soru2-4.alternatif")
arsoru3 = Array("Soru3-1.alternatif", "Soru3-2.alternatif")
arsoru4 = Array("Soru4-1.alternatif", "Soru4-2.alternatif", "Soru4-3.alternatif")
...
s1 = Int(Rnd * UBound(arsoru1))
s2 = Int(Rnd * UBound(arsoru2))
s3 = Int(Rnd * UBound(arsoru3))
s4 = Int(Rnd * UBound(arsoru4))
